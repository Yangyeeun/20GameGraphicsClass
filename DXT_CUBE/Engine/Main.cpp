...
//ID3D11SamplerState DefaultSampler;//하나만
...
void InitD3D(HWND hWnd)
{
	...
	viewport.MaxDepth = 0.99f;    // the farthest an object can be on the depth buffer is 1.0
...
void InitStates()
{
	...
	//sd.MaxAnisotropy = 16; //이방성 필터링 품질
	...
	sd.MaxLOD = FLT_MAX;
	sd.MipLODBias = 0.0f;
	//dev->CreateSamplerState(&sd, &pSS);//샘플링하나만
